...
build-1993783585: ../oled-hardware-i2c.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"D:/TI/CCS/ccs/utils/sysconfig_1.24.0/sysconfig_cli.bat" --script "C:/Users/16200/workspace_ccstheia/m0_follow_car/oled-hardware-i2c.syscfg" -o "." -s "D:/TI/mspm0_sdk_2_05_01_00/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-1993783585 ../oled-hardware-i2c.syscfg
device.opt: build-1993783585
device.cmd.genlibs: build-1993783585
ti_msp_dl_config.c: build-1993783585
ti_msp_dl_config.h: build-1993783585
Event.dot: build-1993783585
